...
window.analytics.methods = ['identify', 'group', 'track', 'page', 'pageview',
  'alias', 'ready', 'on', 'once', 'off', 'trackLink', 'trackForm', 'trackClick',
  'trackSubmit', 'ab'];

// Define a factory to create stubs. These are placeholders for the
...
window.analytics.load('<enter credential here>');
